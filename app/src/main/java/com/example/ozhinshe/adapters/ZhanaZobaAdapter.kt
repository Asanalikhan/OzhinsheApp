...
class ZhanaZobaAdapter(): RecyclerView.Adapter<ZhanaZobaAdapter.ZhanaZobaViewHolder>() {

    private val adapterList = mutableListOf<Movy>()
    private var itemClickListener: OnItemClickListener? = null
    inner class ZhanaZobaViewHolder(private val binding: SearchCardBinding): RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(
        ...
        return ZhanaZobaViewHolder(SearchCardBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    override fun onBindViewHolder(holder: ZhanaZobaAdapter.ZhanaZobaViewHolder, position: Int) {
