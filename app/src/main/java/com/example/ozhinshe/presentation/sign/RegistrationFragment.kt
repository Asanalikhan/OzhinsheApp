...
class RegistrationFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        binding.btnRegistration.setOnClickListener {
            ...
            if (access && access1 && access2) {
                regirst(
                    com.example.ozhinshe.domain.models.RegistrationRequest(
                        email,
                        password
                    )
                ) { success ->
    ...
    private fun regirst(registrationRequest: com.example.ozhinshe.domain.models.RegistrationRequest, onComplete: (Boolean) -> Unit){
