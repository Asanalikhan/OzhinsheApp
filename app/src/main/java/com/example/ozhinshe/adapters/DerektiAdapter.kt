...
class DerektiAdapter(childFragmentManager: FragmentManager): RecyclerView.Adapter<DerektiAdapter.DerektiViewHolder>() {
    private val adapterList = mutableListOf<Movy>()
    private var itemClickListener: OnItemClickListener? = null

    inner class DerektiViewHolder(private val binding: CardMovieBinding): RecyclerView.ViewHolder(binding.root){
