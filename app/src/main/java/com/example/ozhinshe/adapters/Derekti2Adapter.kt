...
class Derekti2Adapter(): RecyclerView.Adapter<Derekti2Adapter.Derekti2ViewHolder>() {

    private val adapterList = mutableListOf<Movy>()
    private var itemClickListener: OnItemClickListener? = null
    inner class Derekti2ViewHolder(private val binding: SearchCardBinding): RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(
        ...
        return Derekti2ViewHolder(SearchCardBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    override fun onBindViewHolder(holder: Derekti2Adapter.Derekti2ViewHolder, position: Int) {
